...
metadata: {"skill-runner":{"emoji":"📧","requires":{"bins":["gog","gemini","jq","date"]}}}
---
...
### View Log
```bash
cat $HOME/skills/morning-email-rollup-log.md
```
...
6. **Sends to Telegram** - Delivers via Skill Runner's messaging system
...
```
$HOME/skills/morning-email-rollup-log.md
```
