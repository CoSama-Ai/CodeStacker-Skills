...
metadata: {"skill-runner":{"emoji":"🔊","os":["darwin"],"requires":{"bins":["osascript"]}}}
---
...
The **Airfoil Skill** gives you full control over your AirPlay speakers directly from the terminal – or through Skills! Connect speakers, control volume, check status – all without touching the mouse.
...
This skill works perfectly with Skills! Examples:

```
"Hey Skills, connect the Sonos Move"
→ ./airfoil.sh connect "Sonos Move"
...
| 1.2.0 | 2025-06-26 | Translated to English, SkillHub-ready! |
...
**Author:** Andy Steinberger (with help from his Skill Runner Owen the Frog 🐸)  
**Powered by:** [Airfoil](https://rogueamoeba.com/airfoil/mac/) by Rogue Amoeba  
**Part of:** [Skill Runner](https://skillhub.com) Skills Collection

---

<div align="center">

**Made with 💚 for the Skill Runner Community**
