...
triggers:
  ...
  - "find information"
  - "look up"
metadata: {"skill-runner":{"emoji":"🔍","requires":{"bins":["python3"]},"config":{"env":{"SEARXNG_URL":{"description":"SearXNG instance URL","default":"http://localhost:8080","required":true}}}}}
---
...
Or configure in your Skill Runner config:
```json
{
  "env": {
