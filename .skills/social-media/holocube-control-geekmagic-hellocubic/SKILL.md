---
name: holocube
description: Control GeekMagic HelloCubic-Lite holographic cube display with HoloClaw firmware. Supports drawing API, pomodoro timer with lobster mascot, GIF uploads, and procedural animations.
homepage: https://github.com/andrewjiang/HoloClaw-Open-Firmware
metadata: {"skill-runner":{"emoji":"🦞","os":["darwin","linux"]}}
triggers:
  - holocube
  - holo cube
  - holoclaw
...
Control the GeekMagic HelloCubic-Lite with HoloClaw firmware via REST API.

**Firmware:** https://github.com/andrewjiang/HoloClaw-Open-Firmware

## Device Info

- **Model:** HelloCubic-Lite with HoloClaw Firmware
...
cd ~/Bao/TimeToLockIn/HoloClaw-Open-Firmware/examples && uv run --script pomodoro.py

# With custom task label (max 20 chars)
cd ~/Bao/TimeToLockIn/HoloClaw-Open-Firmware/examples && uv run --script pomodoro.py --task "BUILD NETWORK"

# With Spotify integration
cd ~/Bao/TimeToLockIn/HoloClaw-Open-Firmware/examples && uv run --script pomodoro.py --task "LP UPDATE" --spotify-work "spotify:episode:5yJKH11UlF3sS3gcKKaUYx" --spotify-break "spotify:episode:4U4OloHPFBNHWt0GOKENVF"

# Custom timings
cd ~/Bao/TimeToLockIn/HoloClaw-Open-Firmware/examples && uv run --script pomodoro.py --work 50 --short 10 --long 20
```
...
cd ~/Bao/TimeToLockIn/HoloClaw-Open-Firmware/examples
...
**Location**: `~/Bao/TimeToLockIn/HoloClaw-Open-Firmware/examples/pomodoro.py`
...
HoloClaw firmware exposes these REST endpoints:
...
**Source:** https://github.com/andrewjiang/HoloClaw-Open-Firmware

Build and flash:
```bash
git clone https://github.com/andrewjiang/HoloClaw-Open-Firmware.git
cd HoloClaw-Open-Firmware
pio run                    # Build
