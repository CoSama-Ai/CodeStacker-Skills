...
homepage: local
metadata: {"skill-runner":{"emoji":"🏠","os":["darwin"]}}
triggers:
  - music scene
  - morning music
  - party mode
...
| 🎵 **spotify-applescript** | Skill Runner skill for Spotify control | `skills/spotify-applescript/` |
...
chmod +x ~/skills/skills/home-music/home-music.sh

# Symlink for global access
sudo ln -sf ~/skills/skills/home-music/home-music.sh /usr/local/bin/home-music
```
...
```bash
~/skills/skills/spotify-applescript/spotify.sh status
```
...
```bash
ls ~/skills/skills/spotify-applescript/spotify.sh
```
