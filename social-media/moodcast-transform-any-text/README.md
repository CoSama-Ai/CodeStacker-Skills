...
git clone https://github.com/ashutosh887/moodcast ~/.skill-runner/skills/moodcast
...
Or add to `~/.skill-runner/moltbot.json`:
```json
{
  "skills": {
    "entries": {
...
**Via Command Line:**
```bash
python3 ~/.skill-runner/skills/moodcast/scripts/moodcast.py --text "Hello world!"
```
...
### Moltbot Config (`~/.skill-runner/moltbot.json`)
...
2. **Managed skills**: `~/.skill-runner/skills/moodcast` (shared across agents)
...
Built for the #SkillsEleven Hackathon (ElevenLabs × Moltbot)
