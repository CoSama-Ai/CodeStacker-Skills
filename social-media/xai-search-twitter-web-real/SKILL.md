...
python ~/.skill-runner/skills/xai-search/scripts/xai-search.py web "latest news about AI"

# X/Twitter search  
python ~/.skill-runner/skills/xai-search/scripts/xai-search.py x "what are people saying about Skill Runner"

# Both
python ~/.skill-runner/skills/xai-search/scripts/xai-search.py both "current events today"
```
